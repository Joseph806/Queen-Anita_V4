...
global.anitav4 = process.env.BOT_NAME || "𝐐𝐔𝐄𝐄𝐍_𝐀𝐍𝐈𝐓𝐀";
global.ownername = process.env.OWNER_NAME || "Willis";
global.packname = process.env.PACK_NAME || "JOSEPH";
global.author = process.env.AUTHOR || "Willis";
global.channelname = process.env.CHANNEL_NAME || "Kïñgpîñtéçh";
